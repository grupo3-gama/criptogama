    ...
    return (
      <div className="desc-content">
        <div className="seletor">
          <Seletor
            className={this.state.tab === "descricao" ? "active" : ""}
            onClick={() => this.setState({ tab: "descricao" })}
          >
            Descricao
          </Seletor>
          <Seletor
            className={this.state.tab === "grafico" ? "active" : ""}
            onClick={() => this.setState({ tab: "grafico" })}
          >
            Gráfico
          </Seletor>
          <Seletor
        ...
        <div className="desc-text">
          <div
            className="text-item"
            style={{
              display: this.state.tab === "descricao" ? "block" : "none",
            }}
          >
            <DescTexto />
          </div>
